...
export class PortfolioComponent {
  ...
  projects = [
    ...
    {title: 'Original Video Game', role:'Creator', dates: 'Nov 2023 - Present', description: 'Original video game created in GameMaker Studio 2. All of the art, music, and game logic has been created by me.', image:'../../../assets/videoGame.png'},
  ]
